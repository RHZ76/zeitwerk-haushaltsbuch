...
$('#backup').onclick=()=>download(`haushaltsbuch-backup-${today()}.json`,JSON.stringify({app:'Haushaltsbuch',schema:1,version:'0.2.7',exported:new Date().toISOString(),data:state},null,2),'application/json');
