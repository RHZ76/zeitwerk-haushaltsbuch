...
$('#date').value=today();$('#monthFilter').value=ymNow();$('#analyticsMonth').value=ymNow();
...
$('#backup').onclick=()=>download(`haushaltsbuch-backup-${today()}.json`,JSON.stringify({app:'Haushaltsbuch',schema:1,version:'0.1.8',exported:new Date().toISOString(),data:state},null,2),'application/json');
