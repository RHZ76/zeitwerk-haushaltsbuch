...
$('#backup').onclick=()=>download(`haushaltsbuch-backup-${today()}.json`,JSON.stringify({app:'Haushaltsbuch',schema:1,version:'0.1.9',exported:new Date().toISOString(),data:state},null,2),'application/json');
